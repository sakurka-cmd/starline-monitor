    ...
    <Card className="w-full max-w-md mx-auto bg-slate-900/80 border-slate-700 backdrop-blur-sm">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button 
            type="submit" 
            className="w-full h-12 text-base bg-blue-600 hover:bg-blue-700 text-white touch-manipulation"
            disabled={isLoading}
          ...
          <div className="text-center">
            <button
              ...
              className="text-sm text-blue-400 hover:text-blue-300 transition-colors py-2"
            >
